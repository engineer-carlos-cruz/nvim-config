...
-- UNA sola barra de estado para todas las ventanas (la usa lualine).
vim.opt.laststatus = 3

-- El modo activo lo muestra lualine, así que no hace falta el texto nativo
-- "INSERTAR" / "NORMAL" del propio Neovim.
vim.opt.showmode = false

-- Menú de autocompletado: mostrar los items sin seleccionar uno por defecto
-- (nvim-cmp se encarga de la selección).
...
-- Previsualiza en vivo las sustituciones (:s/a/b) en una ventana dividida.
...
-- Permite usar el ratón para mover el cursor, redimensionar ventanas
-- y seleccionar texto en todos los modos.
vim.opt.mouse = "a"

-- ============ 5. Optional: netrw (el explorador incluido) ============

-- netrw es el navegador de archivos incluido en Neovim (se abre con
-- <leader>e). Estas dos opciones lo dejan algo más presentable.
vim.g.netrw_banner = 0              -- sin el banner superior
vim.g.netrw_liststyle = 3           -- vista tipo árbol